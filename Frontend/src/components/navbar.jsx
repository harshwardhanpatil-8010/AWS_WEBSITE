...
const Navbar = () => {
  ...
  return (
    <nav
      ref={menuRef}
      className={`fixed  left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-[#ffffff] rounded-full px-8 py-4 w-[90%] max-w-[1200px]  transition-transform duration-300 shadow-lg z-50 ${
